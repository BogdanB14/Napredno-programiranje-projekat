...
public class KonfiguracijaPortaForma extends javax.swing.JDialog {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(34, 34, 34)
                        .addComponent(jTextFieldPort, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(156, 156, 156)
    ...
    private void jButtonSacuvajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSacuvajActionPerformed
        ...
        if(port >= 0 && port <= 65535){
            ...
            JOptionPane.showMessageDialog(this, "Uspesno sacuvan port", "USPEH", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
            return;
        }
        JOptionPane.showMessageDialog(this, "Port nije sacuvan", "GRESKA", JOptionPane.ERROR_MESSAGE);
